...
MySQL - 5.7.27 : Database - fishmall_admin
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`fishmall_admin` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
INSERT INTO `sys_menu` (`menu_id`, `parent_id`, `name`, `url`, `perms`, `type`, `icon`, `order_num`) VALUES
	...
	(76, 43, '规格维护', 'product/attrupdate', '', 1, 'zonghe', 0);
